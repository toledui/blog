<x-app-layout>
    <div class="container">
        <h1 class="mt-6 text-4xl font-bold text-gray-600 uppercase text-center">Todas las entradas de la categoría: <span class="text-indigo-600">{{$category->name}}</span></h1>
